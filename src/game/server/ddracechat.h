...
CHAT_COMMAND("afk", "", CFGFLAG_CHAT, ConAfk, this, "Toggles AFK mode", AUTHED_NO)
...
CHAT_COMMAND("dailyreward", "", CFGFLAG_CHAT, ConDailyReward, this, "Claims the daily money reward", AUTHED_NO)
