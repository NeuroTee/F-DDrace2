...
MACRO_CONFIG_INT(SvPlotMaxBuilders, sv_plot_max_builders, 10, 0, 100, CFGFLAG_SERVER, "Maximum number of builders per plot", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvBankCreditEnabled, sv_bank_credit_enabled, 1, 0, 1, CFGFLAG_SERVER|CFGFLAG_GAME, "Whether bank credits are enabled", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvBankCreditDailyInterest, sv_bank_credit_daily_interest, 1, 0, 100, CFGFLAG_SERVER|CFGFLAG_GAME, "Daily interest percentage for bank credits", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvBankCreditMinAmount, sv_bank_credit_min_amount, 1000, 1, 1000000000, CFGFLAG_SERVER|CFGFLAG_GAME, "Minimum credit amount", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvBankCreditMaxAmount, sv_bank_credit_max_amount, 10000000, 1, 1000000000, CFGFLAG_SERVER|CFGFLAG_GAME, "Maximum credit amount", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvBankCreditMinDays, sv_bank_credit_min_days, 1, 1, 365, CFGFLAG_SERVER|CFGFLAG_GAME, "Minimum credit term in days", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvBankCreditMaxDays, sv_bank_credit_max_days, 30, 1, 365, CFGFLAG_SERVER|CFGFLAG_GAME, "Maximum credit term in days", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvDailyRewardMoney, sv_daily_reward_money, 1000, 0, 1000000000, CFGFLAG_SERVER, "Daily reward amount (money)", AUTHED_ADMIN)
