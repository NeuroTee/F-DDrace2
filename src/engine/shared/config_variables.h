...
MACRO_CONFIG_INT(SvAfkEnable, sv_afk_enable, 1, 0, 1, CFGFLAG_SERVER, "Enable the /afk mode toggle", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvAfkAutoDisableOnInput, sv_afk_auto_disable_on_input, 1, 0, 1, CFGFLAG_SERVER, "Disable AFK mode on player input", AUTHED_ADMIN)
MACRO_CONFIG_INT(SvAfkProtectFromWorld, sv_afk_protect_from_world, 0, 0, 1, CFGFLAG_SERVER, "Protect AFK players from world damage (death tiles, game layer)", AUTHED_ADMIN)
